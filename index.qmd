...
1. Avoid users to have to walk pass the [dependency hell](https://en.wikipedia.org/wiki/Dependency_hell).

   - Long chains of dependencies
   - Conflicting dependencies

2. Avoid users reporting bugs that only work on their computer.
3. Share alias for the command line interface (cli).

## Limitations

1. Computation (as in number of CPU)
2. Storage (as in size of HDD)
3. Transfer (as in speed of Internet connection)
